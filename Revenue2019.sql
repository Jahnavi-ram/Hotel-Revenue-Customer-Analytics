...
FROM `hotelanalyticsproject.hotel_revenue_analysis.INFORMATION_SCHEMA.COLUMNS`  
WHERE table_name = 'historical_revenue_2019';

SELECT *, COUNT(*) AS duplicate_count
FROM `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019`
...
UPDATE `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019`
...
SELECT DISTINCT company FROM `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019`;
SELECT DISTINCT agent FROM `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019`;
UPDATE `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019`
SET agent = 'Novalue'
WHERE agent = 'NULL';
...
CREATE OR REPLACE TABLE `hotelanalyticsproject.hotel_revenue_analysis.historical_revenue_2019` AS
